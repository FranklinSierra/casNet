...
def load_data(subfolder='', generator=False):
    ...
    #CTFOSCAL_path = os.path.join('data', subfolder, 'CTFOSCAL')
    #CTHEALTHY_path = os.path.join('data', subfolder, 'CTHEALTHY')
    ...
    #CTFOSCAL_image_names = sorted(os.listdir(CTFOSCAL_path))
    #CTHEALTHY_image_names = sorted(os.listdir(CTHEALTHY_path))
    ...
    #revisar posible cambio en nr_of_channels para frank
    ...
    #CTFOSCAL_images = create_image_array(CTFOSCAL_image_names, CTFOSCAL_path, image_size, nr_of_channels)
    #CTHEALTHY_images = create_image_array(CTHEALTHY_image_names, CTHEALTHY_path, image_size, nr_of_channels)
    ...
    return {"image_size": image_size, "nr_of_channels": nr_of_channels,
            ...
            #"CTFOSCAL_images": CTFOSCAL_images,
            #"CTFOSCAL_image_names": CTFOSCAL_image_names,
            #"CTHEALTHY_images": CTHEALTHY_images,
            #"CTHEALTHY_image_names": CTHEALTHY_image_names}
